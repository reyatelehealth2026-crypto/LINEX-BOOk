        ...
        <div className="card p-6 max-w-sm w-full space-y-3">
          ...
          <div>
            ...
            <div className="mt-3 text-xs text-ink-400">
              ตรวจสอบ <code className="bg-ink-100 px-1 rounded">NEXT_PUBLIC_LIFF_ID</code> ใน <code className="bg-ink-100 px-1 rounded">.env.local</code> และต้องเปิดผ่าน <code className="bg-ink-100 px-1 rounded">liff.line.me/&lt;id&gt;</code>
            </div>
          </div>
        </div>
      </div>
